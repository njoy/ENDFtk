...
SCENARIO( "nubar::EnergyDependent" ) {
  ...
  GIVEN( "a string representation of a valid nubar::EnergyDependent" ) {
    ...
    THEN( "a nubar::EnergyDependent can be constructed and members can be tested" ) {
      ...
      REQUIRE( 2 == energies.size() );
      REQUIRE( 1e-5 == Approx( energies[0] ) );
      REQUIRE( 2e+7 == Approx( energies[1] ) );
      REQUIRE( 2 == lambdas.size() );
      REQUIRE( 6 == lambdas[0].size() );
      REQUIRE( 1. == Approx( lambdas[0][0] ) );
      REQUIRE( 2. == Approx( lambdas[0][1] ) );
      REQUIRE( 3. == Approx( lambdas[0][2] ) );
      REQUIRE( 4. == Approx( lambdas[0][3] ) );
      REQUIRE( 5. == Approx( lambdas[0][4] ) );
      REQUIRE( 6. == Approx( lambdas[0][5] ) );
      REQUIRE( 6 == lambdas[1].size() );
      REQUIRE( 6. == Approx( lambdas[1][0] ) );
      REQUIRE( 5. == Approx( lambdas[1][1] ) );
      REQUIRE( 4. == Approx( lambdas[1][2] ) );
      REQUIRE( 3. == Approx( lambdas[1][3] ) );
      REQUIRE( 2. == Approx( lambdas[1][4] ) );
      REQUIRE( 1. == Approx( lambdas[1][5] ) );
      REQUIRE( 2 == alphas.size() );
      REQUIRE( 6 == alphas[0].size() );
      REQUIRE( 1.1 == Approx( alphas[0][0] ) );
      REQUIRE( 2.1 == Approx( alphas[0][1] ) );
      REQUIRE( 3.1 == Approx( alphas[0][2] ) );
      REQUIRE( 4.1 == Approx( alphas[0][3] ) );
      REQUIRE( 5.1 == Approx( alphas[0][4] ) );
      REQUIRE( 6.1 == Approx( alphas[0][5] ) );
      REQUIRE( 6 == lambdas[1].size() );
      REQUIRE( 6.1 == Approx( alphas[1][0] ) );
      REQUIRE( 5.1 == Approx( alphas[1][1] ) );
      REQUIRE( 4.1 == Approx( alphas[1][2] ) );
      REQUIRE( 3.1 == Approx( alphas[1][3] ) );
      REQUIRE( 2.1 == Approx( alphas[1][4] ) );
      REQUIRE( 1.1 == Approx( alphas[1][5] ) );
    }
  } // GIVEN
