...
public:
   ...
   */
  decltype(auto) interpolants() const { return this->real_.interpolants(); }

  /**
   *  @brief Return the interpolation range boundaries.
   */
  decltype(auto) boundaries() const { return this->real_.boundaries(); }

  /**
   *  @brief Return the energy values
   */
  decltype(auto) E() const { return this->real_.x(); }
   ...
   */
  decltype(auto) RBR() const { return this->real_.y(); }

  /**
   *  @brief Return the real component of the R-matrix values
   */
  decltype(auto) real() const { return this->RBR(); }

  /**
   *  @brief Return the imaginary component of the R-matrix values
   */
  decltype(auto) RBI() const { return this->imaginary_.y(); }

  /**
   *  @brief Return the imaginary component of the R-matrix values
   */
  decltype(auto) imaginary() const { return this->RBI(); }
