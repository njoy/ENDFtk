...
SCENARIO( "TabulatedDistributions" ) {
  ...
  GIVEN( "valid data for a TabulatedDistributions" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      TabulatedDistributions chunk( energy, level,
                                    std::move( boundaries ),
    ...
    WHEN( "the data is read from a string/stream" ) {
      ...
      TabulatedDistributions chunk( begin, end, lineNumber, 9228, 14, 2 );
  ...
  GIVEN( "invalid data for a TabulatedDistributions" ) {
    ...
    WHEN( "something is wrong with the interpolation sequence record" ) {
      ...
      THEN( "an exception is thrown upon construction when there is "
        ...
        CHECK_THROWS(
          TabulatedDistributions( energy, level,
...
std::string invalidChunk() {
  return
    " 1.000000+0 2.000000+0          0          0          2          2922814  2     \n"
    "          2          1                                            922814  2     \n"
    " 0.000000+0 1.000000-5          0          0          1          2922814  2     \n"
    "          2          2                                            922814  2     \n"
    "-1.000000+0 5.000000-1 1.000000+0 5.000000-1                      922814  2     \n"
