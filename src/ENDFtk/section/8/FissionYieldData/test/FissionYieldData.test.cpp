...
void verifyChunk( const FissionYieldData& chunk ) {
  ...
  CHECK( 2.05032e-19 == Approx( chunk.fissionProducts()[0].YI() ) );
  CHECK( 7.851250e-4 == Approx( chunk.fissionProducts()[1].YI() ) );
  CHECK( 0 == Approx( chunk.fissionProducts()[2].YI() ) );
  ...
  CHECK( 1.31220e-19 == Approx( chunk.fissionProducts()[0].DYI() ) );
  CHECK( 4.710750e-5 == Approx( chunk.fissionProducts()[1].DYI() ) );
  CHECK( 0 == Approx( chunk.fissionProducts()[2].DYI() ) );
  ...
  CHECK( 3 == chunk.YI().size() );
  CHECK( 3 == chunk.fissionYields().size() );
  CHECK( 3 == chunk.DYI().size() );
  ...
  CHECK( 2.05032e-19 == Approx( chunk.YI()[0] ) );
  CHECK( 7.851250e-4 == Approx( chunk.YI()[1] ) );
  CHECK( 0 == Approx( chunk.YI() [2]) );
  ...
  CHECK( 1.31220e-19 == Approx( chunk.DYI()[0] ) );
  CHECK( 4.710750e-5 == Approx( chunk.DYI()[1] ) );
  CHECK( 0 == Approx( chunk.DYI()[2] ) );
