...
void verifyChunk( const section::Type< 8, 459 >& chunk ) {
  ...
  CHECK( 0 == data.fissionProducts()[1].isomericState() );
  CHECK( 0 == data.fissionProducts()[2].isomericState() );
  CHECK_THAT( 4.48456e-18, WithinRel( data.fissionProducts()[0].FY() ) );
  CHECK_THAT( 1.196100e-3, WithinRel( data.fissionProducts()[1].FY() ) );
  CHECK_THAT( 2.87012e-18, WithinRel( data.fissionProducts()[0].DFY() ) );
  CHECK_THAT( 2.751030e-4, WithinRel( data.fissionProducts()[1].DFY() ) );
  CHECK_THAT( 4.48456e-18, WithinRel( data.fissionProducts()[0].fissionYieldValue() ) );
  CHECK_THAT( 1.196100e-3, WithinRel( data.fissionProducts()[1].fissionYieldValue() ) );
  CHECK_THAT( 2.87012e-18, WithinRel( data.fissionProducts()[0].fissionYieldUncertainty() ) );
  CHECK_THAT( 2.751030e-4, WithinRel( data.fissionProducts()[1].fissionYieldUncertainty() ) );
  ...
  CHECK( 0 == data.isomericStates()[1] );
  CHECK( 0 == data.isomericStates()[2] );
  CHECK_THAT( 4.48456e-18, WithinRel( data.FY()[0] ) );
  CHECK_THAT( 1.196100e-3, WithinRel( data.FY()[1] ) );
  CHECK_THAT( 0, WithinRel( data.FY()[2] ) );
  CHECK_THAT( 2.87012e-18, WithinRel( data.DFY()[0] ) );
  CHECK_THAT( 2.751030e-4, WithinRel( data.DFY()[1] ) );
  CHECK_THAT( 0, WithinRel( data.DFY()[2] ) );
  CHECK_THAT( 4.48456e-18, WithinRel( data.fissionYieldValues()[0] ) );
  CHECK_THAT( 1.196100e-3, WithinRel( data.fissionYieldValues()[1] ) );
  CHECK_THAT( 0, WithinRel( data.fissionYieldValues()[2] ) );
  CHECK_THAT( 2.87012e-18, WithinRel( data.fissionYieldUncertainties()[0] ) );
  CHECK_THAT( 2.751030e-4, WithinRel( data.fissionYieldUncertainties()[1] ) );
  CHECK_THAT( 0, WithinRel( data.fissionYieldUncertainties()[2] ) );
  CHECK( 2 == data.Y()[0].size() );
  CHECK( 2 == data.Y()[1].size() );
  CHECK( 2 == data.Y()[2].size() );
