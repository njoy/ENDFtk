...
void verifyChunkWithLCONZero( const DecaySpectrum& chunk ) {
  ...
  CHECK_THAT( 0., WithinRel( chunk.FC()[0] ) );
  CHECK_THAT( 0., WithinRel( chunk.FC()[1] ) );
  CHECK_THAT( 0., WithinRel( chunk.continuousNormalisationFactor()[0] ) );
  CHECK_THAT( 0., WithinRel( chunk.continuousNormalisationFactor()[1] ) );
...
void verifyChunkWithLCONOne( const DecaySpectrum& chunk ) {
  ...
  CHECK_THAT( 0., WithinRel( chunk.FD()[0] ) );
  CHECK_THAT( 0., WithinRel( chunk.FD()[1] ) );
  CHECK_THAT( 0., WithinRel( chunk.discreteNormalisationFactor()[0] ) );
  CHECK_THAT( 0., WithinRel( chunk.discreteNormalisationFactor()[1] ) );
