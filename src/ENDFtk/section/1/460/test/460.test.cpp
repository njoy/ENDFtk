...
void verifyChunkLO1( const section::Type< 1, 460 >& chunk ) {
  ...
  CHECK( 1 == photons.photons()[0].numberInterpolationRegions() );
  CHECK( 2 == photons.photons()[0].NP() );
  CHECK( 2 == photons.photons()[0].numberPoints() );
  CHECK( 1 == photons.photons()[0].INT().size() );
  CHECK( 1 == photons.photons()[0].NBT().size() );
  CHECK( 4 == photons.photons()[0].INT()[0] );
  CHECK( 2 == photons.photons()[0].NBT()[0] );
  ...
  CHECK( 1 == photons.photons()[1].numberInterpolationRegions() );
  CHECK( 3 == photons.photons()[1].NP() );
  CHECK( 3 == photons.photons()[1].numberPoints() );
  CHECK( 1 == photons.photons()[1].INT().size() );
  CHECK( 1 == photons.photons()[1].NBT().size() );
  CHECK( 2 == photons.photons()[1].INT()[0] );
  CHECK( 3 == photons.photons()[1].NBT()[0] );
