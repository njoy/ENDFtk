...
void verifyChunk( const GeneralRMatrixLimited& chunk ) {
  ...
  CHECK_THAT( 0., WithinRel( parameters2.GAM()[0][1] ) );
  ...
  CHECK_THAT( 0., WithinRel( parameters2.GAM()[1][1] ) );
  ...
  CHECK_THAT( 0., WithinRel( parameters2.GAM()[2][1] ) );
  CHECK_THAT( 0., WithinRel( parameters2.GAM()[2][2] ) );
  CHECK_THAT( 0., WithinRel( parameters2.GAM()[2][3] ) );
  CHECK_THAT( 0., WithinRel( parameters2.GAM()[2][4] ) );
  ...
  CHECK_THAT( 0., WithinRel( parameters2.resonanceParameters()[0][1] ) );
  ...
  CHECK_THAT( 0., WithinRel( parameters2.resonanceParameters()[1][1] ) );
  ...
  CHECK_THAT( 0., WithinRel( parameters2.resonanceParameters()[2][1] ) );
  CHECK_THAT( 0., WithinRel( parameters2.resonanceParameters()[2][2] ) );
  CHECK_THAT( 0., WithinRel( parameters2.resonanceParameters()[2][3] ) );
  CHECK_THAT( 0., WithinRel( parameters2.resonanceParameters()[2][4] ) );
