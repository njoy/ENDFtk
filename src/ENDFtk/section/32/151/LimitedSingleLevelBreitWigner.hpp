...
class LimitedSingleLevelBreitWigner :
  protected LimitedBreitWignerBase< BreitWignerLValue, LimitedSingleLevelBreitWigner > {

  friend LimitedBreitWignerBase< BreitWignerLValue, LimitedSingleLevelBreitWigner >;
