...
void verifyChunk( const CompactRMatrixLimitedUncertainties& chunk ) {
  ...
  CHECK( 1. == Approx( parameters1.DER()[0] ) );
  CHECK( 2. == Approx( parameters1.DER()[1] ) );
  CHECK( 1. == Approx( parameters1.resonanceEnergyUncertainties()[0] ) );
  CHECK( 2. == Approx( parameters1.resonanceEnergyUncertainties()[1] ) );
  CHECK( 5 == parameters1.DGAM()[0].size() );
  CHECK( 5 == parameters1.DGAM()[1].size() );
  CHECK( 3. == Approx( parameters1.DGAM()[0][0] ) );
  CHECK( 4. == Approx( parameters1.DGAM()[0][1] ) );
  CHECK( 0. == Approx( parameters1.DGAM()[0][2] ) );
  CHECK( 0. == Approx( parameters1.DGAM()[0][3] ) );
  CHECK( 0. == Approx( parameters1.DGAM()[0][4] ) );
  CHECK( 5. == Approx( parameters1.DGAM()[1][0] ) );
  CHECK( 6. == Approx( parameters1.DGAM()[1][1] ) );
  ...
  CHECK( 3. == Approx( parameters1.resonanceParameterUncertainties()[0][0] ) );
  CHECK( 4. == Approx( parameters1.resonanceParameterUncertainties()[0][1] ) );
  ...
  CHECK( 5. == Approx( parameters1.resonanceParameterUncertainties()[1][0] ) );
  CHECK( 6. == Approx( parameters1.resonanceParameterUncertainties()[1][1] ) );
  ...
  CHECK(  7. == Approx( parameters2.DER()[0] ) );
  CHECK(  8. == Approx( parameters2.DER()[1] ) );
  CHECK(  7. == Approx( parameters2.resonanceEnergyUncertainties()[0] ) );
  CHECK(  8. == Approx( parameters2.resonanceEnergyUncertainties()[1] ) );
  CHECK(  5 == parameters2.DGAM()[0].size() );
  CHECK(  5 == parameters2.DGAM()[1].size() );
  CHECK(  9. == Approx( parameters2.DGAM()[0][0] ) );
  CHECK( 10. == Approx( parameters2.DGAM()[0][1] ) );
  CHECK(  0. == Approx( parameters2.DGAM()[0][2] ) );
  CHECK(  0. == Approx( parameters2.DGAM()[0][3] ) );
  CHECK(  0. == Approx( parameters2.DGAM()[0][4] ) );
  CHECK( 11. == Approx( parameters2.DGAM()[1][0] ) );
  CHECK( 12. == Approx( parameters2.DGAM()[1][1] ) );
  CHECK(  0. == Approx( parameters2.DGAM()[1][2] ) );
  CHECK(  0. == Approx( parameters2.DGAM()[1][3] ) );
  CHECK(  0. == Approx( parameters2.DGAM()[1][4] ) );
  CHECK(  5 == parameters2.resonanceParameterUncertainties()[0].size() );
  CHECK(  5 == parameters2.resonanceParameterUncertainties()[1].size() );
  CHECK(  9. == Approx( parameters2.resonanceParameterUncertainties()[0][0] ) );
  CHECK( 10. == Approx( parameters2.resonanceParameterUncertainties()[0][1] ) );
  CHECK(  0. == Approx( parameters2.resonanceParameterUncertainties()[0][2] ) );
  CHECK(  0. == Approx( parameters2.resonanceParameterUncertainties()[0][3] ) );
  CHECK(  0. == Approx( parameters2.resonanceParameterUncertainties()[0][4] ) );
  CHECK( 11. == Approx( parameters2.resonanceParameterUncertainties()[1][0] ) );
  CHECK( 12. == Approx( parameters2.resonanceParameterUncertainties()[1][1] ) );
  CHECK(  0. == Approx( parameters2.resonanceParameterUncertainties()[1][2] ) );
  CHECK(  0. == Approx( parameters2.resonanceParameterUncertainties()[1][3] ) );
  CHECK(  0. == Approx( parameters2.resonanceParameterUncertainties()[1][4] ) );
