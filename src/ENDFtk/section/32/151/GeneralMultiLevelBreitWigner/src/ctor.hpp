 ...
 */
GeneralMultiLevelBreitWigner( double awri, double spi, double ap, double dap,
                              unsigned int nls,
 ...
 *  @param[in] clong     the long range covariance blocks
 */
GeneralMultiLevelBreitWigner( double awri, double spi, double ap, unsigned int nls,
                              std::vector< ShortRangeBreitWignerBlock >&& cshort,
                              std::vector< LongRangeCovarianceBlock >&& clong )
