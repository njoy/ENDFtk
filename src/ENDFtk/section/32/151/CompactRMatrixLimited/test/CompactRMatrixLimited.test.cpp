...
void verifyChunk( const CompactRMatrixLimited& chunk ) {
  ...
  CHECK( 65.37 == Approx( pairs.MB()[0] ) );
  CHECK( 64.37 == Approx( pairs.MB()[1] ) );
  CHECK( 65.37 == Approx( pairs.massParticleB()[0] ) );
  CHECK( 64.37 == Approx( pairs.massParticleB()[1] ) );
  ...
  CHECK( 0. == Approx( pairs.ZB()[0] ) );
  CHECK( 0. == Approx( pairs.ZB()[1] ) );
  CHECK( 0. == Approx( pairs.chargeParticleB()[0] ) );
  CHECK( 0. == Approx( pairs.chargeParticleB()[1] ) );
  ...
  CHECK( -1.5 == Approx( pairs.IB()[1] ) );
  CHECK( 0. == Approx( pairs.spinParticleB()[0] ) );
  CHECK( -1.5 == Approx( pairs.spinParticleB()[1] ) );
  ...
  CHECK( 0. == Approx( pairs.PB()[1] ) );
  CHECK( 0. == Approx( pairs.parityParticleB()[0] ) );
  CHECK( 0. == Approx( pairs.parityParticleB()[1] ) );
  ...
  CHECK( -1. == Approx( group1.AJ() ) );
  CHECK( -1. == Approx( group1.spin() ) );
  ...
  CHECK( -1. == Approx( channels1.AJ() ) );
  CHECK( -1. == Approx( channels1.spin() ) );
  ...
  CHECK( 1. == Approx( channels1.SCH()[1] ) );
  CHECK( 0. == Approx( channels1.channelSpinValues()[0] ) );
  CHECK( 1. == Approx( channels1.channelSpinValues()[1] ) );
  ...
  CHECK( 0.67 == Approx( channels1.APT()[1] ) );
  CHECK( 0. == Approx( channels1.trueChannelRadii()[0] ) );
  CHECK( 0.67 == Approx( channels1.trueChannelRadii()[1] ) );
  CHECK( 0. == Approx( channels1.APE()[0] ) );
  CHECK( 0.67 == Approx( channels1.APE()[1] ) );
  CHECK( 0. == Approx( channels1.effectiveChannelRadii()[0] ) );
  CHECK( 0.67 == Approx( channels1.effectiveChannelRadii()[1] ) );
  ...
  CHECK( -1.535904e+3 == Approx( parameters1.ER()[0] ) );
  CHECK(  1.363096e+3 == Approx( parameters1.ER()[1] ) );
  CHECK(  2.648648e+3 == Approx( parameters1.ER()[2] ) );
  CHECK(  3.585385e+3 == Approx( parameters1.ER()[3] ) );
  CHECK( -1.535904e+3 == Approx( parameters1.resonanceEnergies()[0] ) );
  CHECK(  1.363096e+3 == Approx( parameters1.resonanceEnergies()[1] ) );
  CHECK(  2.648648e+3 == Approx( parameters1.resonanceEnergies()[2] ) );
  CHECK(  3.585385e+3 == Approx( parameters1.resonanceEnergies()[3] ) );
  CHECK( 5 == parameters1.GAM()[0].size() );
  CHECK( 5 == parameters1.GAM()[1].size() );
  CHECK( 5 == parameters1.GAM()[2].size() );
  CHECK( 5 == parameters1.GAM()[3].size() );
  CHECK( 3.950000e-1 == Approx( parameters1.GAM()[0][0] ) );
  CHECK( 2.943392e+2 == Approx( parameters1.GAM()[0][1] ) );
  CHECK( 0. == Approx( parameters1.GAM()[0][2] ) );
  CHECK( 0. == Approx( parameters1.GAM()[0][3] ) );
  CHECK( 0. == Approx( parameters1.GAM()[0][4] ) );
  CHECK( 3.950000e-1 == Approx( parameters1.GAM()[1][0] ) );
  CHECK( 2.778162e-2 == Approx( parameters1.GAM()[1][1] ) );
  CHECK( 0. == Approx( parameters1.GAM()[1][2] ) );
  CHECK( 0. == Approx( parameters1.GAM()[1][3] ) );
  CHECK( 0. == Approx( parameters1.GAM()[1][4] ) );
  CHECK( 3.950000e-1 == Approx( parameters1.GAM()[2][0] ) );
  CHECK( 2.358290e-3 == Approx( parameters1.GAM()[2][1] ) );
  CHECK( 0. == Approx( parameters1.GAM()[2][2] ) );
  CHECK( 0. == Approx( parameters1.GAM()[2][3] ) );
  CHECK( 0. == Approx( parameters1.GAM()[2][4] ) );
  CHECK( 3.950000e-1 == Approx( parameters1.GAM()[3][0] ) );
  CHECK( 5.706056e-2 == Approx( parameters1.GAM()[3][1] ) );
  CHECK( 0. == Approx( parameters1.GAM()[3][2] ) );
  CHECK( 0. == Approx( parameters1.GAM()[3][3] ) );
  CHECK( 0. == Approx( parameters1.GAM()[3][4] ) );
  ...
  CHECK( 3.950000e-1 == Approx( parameters1.resonanceParameters()[0][0] ) );
  CHECK( 2.943392e+2 == Approx( parameters1.resonanceParameters()[0][1] ) );
  ...
  CHECK( 3.950000e-1 == Approx( parameters1.resonanceParameters()[1][0] ) );
  CHECK( 2.778162e-2 == Approx( parameters1.resonanceParameters()[1][1] ) );
  ...
  CHECK( 3.950000e-1 == Approx( parameters1.resonanceParameters()[2][0] ) );
  CHECK( 2.358290e-3 == Approx( parameters1.resonanceParameters()[2][1] ) );
  CHECK( 0. == Approx( parameters1.resonanceParameters()[2][2] ) );
  CHECK( 0. == Approx( parameters1.resonanceParameters()[2][3] ) );
  CHECK( 0. == Approx( parameters1.resonanceParameters()[2][4] ) );
  CHECK( 3.950000e-1 == Approx( parameters1.resonanceParameters()[3][0] ) );
  CHECK( 5.706056e-2 == Approx( parameters1.resonanceParameters()[3][1] ) );
  CHECK( 0. == Approx( parameters1.resonanceParameters()[3][2] ) );
  CHECK( 0. == Approx( parameters1.resonanceParameters()[3][3] ) );
  CHECK( 0. == Approx( parameters1.resonanceParameters()[3][4] ) );

  CHECK( 1.377556e+1 == Approx( parameters1.DER()[0] ) );
  CHECK( 4.389417e+0 == Approx( parameters1.DER()[1] ) );
  CHECK( 1.889408e+1 == Approx( parameters1.DER()[2] ) );
  CHECK( 6.799781e+0 == Approx( parameters1.DER()[3] ) );
  CHECK( 1.377556e+1 == Approx( parameters1.resonanceEnergyUncertainties()[0] ) );
  CHECK( 4.389417e+0 == Approx( parameters1.resonanceEnergyUncertainties()[1] ) );
  CHECK( 1.889408e+1 == Approx( parameters1.resonanceEnergyUncertainties()[2] ) );
  CHECK( 6.799781e+0 == Approx( parameters1.resonanceEnergyUncertainties()[3] ) );
  ...
  CHECK( 8.403206e-6 == Approx( parameters1.DGAM()[0][0] ) );
  CHECK( 1.026766e-3 == Approx( parameters1.DGAM()[0][1] ) );
  CHECK( 0. == Approx( parameters1.DGAM()[0][2] ) );
  CHECK( 0. == Approx( parameters1.DGAM()[0][3] ) );
  CHECK( 0. == Approx( parameters1.DGAM()[0][4] ) );
  CHECK( 2.802750e-3 == Approx( parameters1.DGAM()[1][0] ) );
  CHECK( 1.169698e-4 == Approx( parameters1.DGAM()[1][1] ) );
  CHECK( 0. == Approx( parameters1.DGAM()[1][2] ) );
  CHECK( 0. == Approx( parameters1.DGAM()[1][3] ) );
  CHECK( 0. == Approx( parameters1.DGAM()[1][4] ) );
  CHECK( 4.333117e-3 == Approx( parameters1.DGAM()[2][0] ) );
  CHECK( 2.987095e-5 == Approx( parameters1.DGAM()[2][1] ) );
  CHECK( 0. == Approx( parameters1.DGAM()[2][2] ) );
  CHECK( 0. == Approx( parameters1.DGAM()[2][3] ) );
  CHECK( 0. == Approx( parameters1.DGAM()[2][4] ) );
  CHECK( 4.163289e-2 == Approx( parameters1.DGAM()[3][0] ) );
  CHECK( 3.271682e-4 == Approx( parameters1.DGAM()[3][1] ) );
  CHECK( 0. == Approx( parameters1.DGAM()[3][2] ) );
  CHECK( 0. == Approx( parameters1.DGAM()[3][3] ) );
  CHECK( 0. == Approx( parameters1.DGAM()[3][4] ) );
  ...
  CHECK( 8.403206e-6 == Approx( parameters1.resonanceParameterUncertainties()[0][0] ) );
  CHECK( 1.026766e-3 == Approx( parameters1.resonanceParameterUncertainties()[0][1] ) );
  CHECK( 0. == Approx( parameters1.resonanceParameterUncertainties()[0][2] ) );
  CHECK( 0. == Approx( parameters1.resonanceParameterUncertainties()[0][3] ) );
  CHECK( 0. == Approx( parameters1.resonanceParameterUncertainties()[0][4] ) );
  CHECK( 2.802750e-3 == Approx( parameters1.resonanceParameterUncertainties()[1][0] ) );
  CHECK( 1.169698e-4 == Approx( parameters1.resonanceParameterUncertainties()[1][1] ) );
  CHECK( 0. == Approx( parameters1.resonanceParameterUncertainties()[1][2] ) );
  CHECK( 0. == Approx( parameters1.resonanceParameterUncertainties()[1][3] ) );
  CHECK( 0. == Approx( parameters1.resonanceParameterUncertainties()[1][4] ) );
  CHECK( 4.333117e-3 == Approx( parameters1.resonanceParameterUncertainties()[2][0] ) );
  CHECK( 2.987095e-5 == Approx( parameters1.resonanceParameterUncertainties()[2][1] ) );
  CHECK( 0. == Approx( parameters1.resonanceParameterUncertainties()[2][2] ) );
  CHECK( 0. == Approx( parameters1.resonanceParameterUncertainties()[2][3] ) );
  CHECK( 0. == Approx( parameters1.resonanceParameterUncertainties()[2][4] ) );
  CHECK( 4.163289e-2 == Approx( parameters1.resonanceParameterUncertainties()[3][0] ) );
  CHECK( 3.271682e-4 == Approx( parameters1.resonanceParameterUncertainties()[3][1] ) );
  CHECK( 0. == Approx( parameters1.resonanceParameterUncertainties()[3][2] ) );
  CHECK( 0. == Approx( parameters1.resonanceParameterUncertainties()[3][3] ) );
  CHECK( 0. == Approx( parameters1.resonanceParameterUncertainties()[3][4] ) );
  ...
  CHECK( -795e-3 == Approx( chunk.correlationMatrix().correlations()[0] ) );
  CHECK( -945e-3 == Approx( chunk.correlationMatrix().correlations()[1] ) );
  CHECK(  665e-3 == Approx( chunk.correlationMatrix().correlations()[2] ) );
  CHECK(   15e-3 == Approx( chunk.correlationMatrix().correlations()[3] ) );
  CHECK(  -25e-3 == Approx( chunk.correlationMatrix().correlations()[4] ) );
  CHECK(  -25e-3 == Approx( chunk.correlationMatrix().correlations()[5] ) );
  CHECK(  -15e-3 == Approx( chunk.correlationMatrix().correlations()[6] ) );
  CHECK(   25e-3 == Approx( chunk.correlationMatrix().correlations()[7] ) );
  CHECK( -595e-3 == Approx( chunk.correlationMatrix().correlations()[8] ) );
  CHECK(  -15e-3 == Approx( chunk.correlationMatrix().correlations()[9] ) );
  CHECK(   25e-3 == Approx( chunk.correlationMatrix().correlations()[10] ) );
  CHECK(   15e-3 == Approx( chunk.correlationMatrix().correlations()[11] ) );
  CHECK(  -55e-3 == Approx( chunk.correlationMatrix().correlations()[12] ) );
  CHECK(  -15e-3 == Approx( chunk.correlationMatrix().correlations()[13] ) );
  CHECK(   15e-3 == Approx( chunk.correlationMatrix().correlations()[14] ) );
  CHECK(  -65e-3 == Approx( chunk.correlationMatrix().correlations()[15] ) );
  CHECK(  165e-3 == Approx( chunk.correlationMatrix().correlations()[16] ) );
