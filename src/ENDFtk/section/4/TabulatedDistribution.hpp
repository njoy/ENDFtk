...
public:
   ...
   */
  decltype(auto) MU() const { return TabulationRecord::x(); }

  /**
   *  @brief Return the cosine values
   */
  decltype(auto) cosines() const { return this->MU(); }

  /**
   *  @brief Return the distribution probabilities
   */
  decltype(auto) F() const { return TabulationRecord::y(); }

  /**
   *  @brief Return the distribution probabilities
   */
  decltype(auto) probabilities() const { return this->F(); }
