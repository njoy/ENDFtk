...
SCENARIO( "section::Type< 6 >::ReactionProduct" ) {
  ...
  GIVEN( "valid data for a "
    ...
    THEN( "a section::Type< 6 >::ReactionProduct can "
      ...
      REQUIRE( 4 == products[0].multiplicity().multiplicity().size() );
      ...
      REQUIRE( 0. == Approx( products[0].multiplicity().multiplicity()[0] ) );
      REQUIRE( 8.45368e-11 == Approx( products[0].multiplicity().multiplicity()[1] ) );
      REQUIRE( 6.622950e-8 == Approx( products[0].multiplicity().multiplicity()[2] ) );
      REQUIRE( 2.149790e-1 == Approx( products[0].multiplicity().multiplicity()[3] ) );
...
std::string chunk() {
  return
    ...
    "          3          2                                            9437 6  5     \n"
    " 1.858639+7 0.000000+0 1.900000+7 0.000000+0 2.000000+7 0.000000+09437 6  5     \n"
    " 0.000000+0 0.000000+0          1          2          1          29437 6  5     \n"
    "          2         22                                            9437 6  5     \n"
    " 0.000000+0 1.858639+7          0          0          6          39437 6  5     \n"
    " 0.000000+0 0.000000+0 5.000000-1 2.000000+0 1.000000+0 0.000000+09437 6  5     \n"
