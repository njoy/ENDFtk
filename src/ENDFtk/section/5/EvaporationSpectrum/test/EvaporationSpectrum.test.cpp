...
SCENARIO( "EvaporationSpectrum" ) {
  ...
  GIVEN( "valid data for a EvaporationSpectrum" ) {
    ...
    WHEN( "the data is given explicitly" ) {
      ...
      EvaporationSpectrum chunk( std::move( boundaries ),
    ...
    WHEN( "the data is read from a string/stream" ) {
      ...
      EvaporationSpectrum chunk( begin, end, lineNumber, 9437, 5, 455 );
  ...
  GIVEN( "invalid data for a EvaporationSpectrum" ) {
    ...
    WHEN( "inconsistent data is used" ) {
      ...
      THEN( "an exception is thrown" ) {
        ...
        REQUIRE_THROWS( EvaporationSpectrum( std::move( boundaries ),
    ...
    WHEN( "a string representation with an error is given" ) {
      ...
      THEN( "an exception is thrown" ) {
        ...
        REQUIRE_THROWS( EvaporationSpectrum( begin, end, lineNumber,
                                             9437, 5, 455 ) );
      } // THEN
    } // WHEN
  } // GIVEN
