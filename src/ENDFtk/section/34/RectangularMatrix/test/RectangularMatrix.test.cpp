...
SCENARIO( "RectangularMatrix" ) {
  ...
  GIVEN( "valid data for a RectangularMatrix" ) {
    ...
    WHEN( "the data is read from a string/stream" ) {
      ...
      RectangularMatrix chunk( begin, end, lineNumber, 9228, 34, 5 );
  ...
  GIVEN( "invalid data for a RectangularMatrix" ) {
    ...
    WHEN( "a string representation is used with an invalid LB" ) {
      ...
      THEN( "an exception is thrown" ) {
        ...
        CHECK_THROWS(
          RectangularMatrix( begin, end, lineNumber, 9228, 34, 5 ) );
      } // THEN
    } // WHEN
...
std::string chunk() {
  return
    " 0.000000+0 0.000000+0          0          6         13          3922834  5     \n"
    " 1.100000+0 1.200000+0 1.300000+0 2.100000+0 2.200000+0 2.300000+0922834  5     \n"
    " 2.400000+0 1.000000+0 2.000000+0 3.000000+0 4.000000+0 5.000000+0922834  5     \n"
    " 6.000000+0                                                       922834  5     \n";
}
...
std::string invalidLB() {
  return
    " 0.000000+0 0.000000+0          0          5         13          3922834  5     \n"
    " 1.100000+0 1.200000+0 1.300000+0 2.100000+0 2.200000+0 2.300000+0922834  5     \n"
    " 2.400000+0 1.000000+0 2.000000+0 3.000000+0 4.000000+0 5.000000+0922834  5     \n"
    " 6.000000+0                                                       922834  5     \n";
}
...
std::string inconsistentEnergies() {
  return
    " 0.000000+0 0.000000+0          0          6         14          3922834  5     \n"
    " 1.100000+0 1.200000+0 1.300000+0 2.100000+0 2.200000+0 2.300000+0922834  5     \n"
    " 2.400000+0 1.000000+0 2.000000+0 3.000000+0 4.000000+0 5.000000+0922834  5     \n"
    " 6.000000+0 7.000000+0                                            922834  5     \n";
}
