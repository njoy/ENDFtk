...
SCENARIO( "section::Type< 7, 4 >" ) {
  ...
  GIVEN( "a valid section::Type< 7, 4 > with two temperatures and one "
         "secondary scatterer with a secondary temperature" ) {
  ...
  GIVEN( "a valid section::Type< 7, 4 > with two temperatures and one "
         "secondary scatterer without a secondary temperature" ) {
