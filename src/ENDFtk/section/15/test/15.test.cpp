...
SCENARIO( "section::Type< 15 >" ) {
  ...
  GIVEN( "valid data for a section::Type< 15 >" ) {
    ...
    WHEN( "there is a tree::Section" ) {
      ...
      section::Type< 15 > chunk3 = section.parse( 15_c );
      section::Type< 15 > chunk4 = section.parse( 15_c, lineNumber );
