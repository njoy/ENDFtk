...
class LValue : protected ListRecord {
  ...
  /* auxiliary functions */
  #include "ENDFtk/resonanceParameters/unresolved/EnergyIndependent/LValue/src/verifySize.hpp"
  #include "ENDFtk/resonanceParameters/unresolved/EnergyIndependent/LValue/src/generateList.hpp"

public:

  /* constructor */
  #include "ENDFtk/resonanceParameters/unresolved/EnergyIndependent/LValue/src/ctor.hpp"
