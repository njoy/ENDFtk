...
std::string chunk() {
  return
    " 3.000000+0 0.000000+0          2          0         12          39228 2151     \n"
...
void verifyChunk( const JValue& chunk ) {
  ...
  CHECK( 3 == chunk.averageLevelSpacing().size() );
  ...
  CHECK( 1.01135 == Approx( chunk.D()[2] ) );
  CHECK( 1.05857 == Approx( chunk.averageLevelSpacing()[0] ) );
  CHECK( 1.055928 == Approx( chunk.averageLevelSpacing()[1] ) );
  CHECK( 1.01135 == Approx( chunk.averageLevelSpacing()[2] ) );
  ...
  CHECK( 1. == Approx( chunk.GX()[1] ) );
  CHECK( 2. == Approx( chunk.GX()[2] ) );
  CHECK( 0. == Approx( chunk.averageCompetitiveWidths()[0] ) );
  CHECK( 1. == Approx( chunk.averageCompetitiveWidths()[1] ) );
  CHECK( 2. == Approx( chunk.averageCompetitiveWidths()[2] ) );
