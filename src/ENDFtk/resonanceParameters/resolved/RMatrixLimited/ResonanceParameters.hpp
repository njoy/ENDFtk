...
class ResonanceParameters : protected ListRecord {
  ...
  /* auxiliary functions */
  #include "ENDFtk/resonanceParameters/resolved/RMatrixLimited/ResonanceParameters/src/generateList.hpp"
  #include "ENDFtk/resonanceParameters/resolved/RMatrixLimited/ResonanceParameters/src/verifySize.hpp"

public:
  /* constructor */
  #include "ENDFtk/resonanceParameters/resolved/RMatrixLimited/ResonanceParameters/src/ctor.hpp"
