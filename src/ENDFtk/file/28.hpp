#ifndef NJOY_ENDFTK_FILE_28
#define NJOY_ENDFTK_FILE_28
...
namespace file {
  ...
  template<>
  class Type< 28 > : public NotImplementedYet< Type< 28 > > {

    friend NotImplementedYet< Type< 28 > >;
  ...
  public:
     ...
     */
    static constexpr int fileNumber() { return 28; }
