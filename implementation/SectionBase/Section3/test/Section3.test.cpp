...
int main( int argc, const char* argv[] ){
  LOG(INFO) << "";
  LOG(INFO) << "Section3 Tests";
  LOG(INFO) << "======================";
  int result = Catch::Session().run( argc, argv );
  LOG(INFO) << "Section3 Complete!";
  return result;
}

SCENARIO( "Section3 tests" ){
  GIVEN( "a string representation of a valid MF=3 Section" ){
    std::string sSection = 
  ...
  GIVEN( 
    "a string representation of an MF=3 Section with negative cross sections" ){
    std::string sSection = 
      " 1.001000+3 9.991673-1          0          0          0          0 125 3  1\n"
      " 0.000000+0 0.000000+0          0          0          2         96 125 3  1\n"
      "         30          5         96          2                       125 3  1\n"
    ...
    THEN( "an exception is thrown upon construction" ){
      REQUIRE_THROWS(ENDFtk::implementation::Section<3> MF3(
              head, begin, end, lineNumber, 125) );
    }
  } // GIVEN
} // SCENARIO
