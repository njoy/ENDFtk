...
struct Base{
  ...
  using ArgumentType =
    ...
    < std::is_trivially_copyable< T >::value,
      T, typename std::add_rvalue_reference< T >::type >::type;

  template< std::size_t index >
  using ElementType  = typename std::tuple_element< index, FieldTuple >::type;

  template< std::size_t index >
  using MutableReturnType =
    typename std::add_lvalue_reference< ElementType< index > >::type;
    ...
    typename std::conditional
             < std::is_trivially_copyable< ElementType< index > >::value,
               ...
               < typename std::add_const
                 < ElementType< index > >::type >::type >::type;
