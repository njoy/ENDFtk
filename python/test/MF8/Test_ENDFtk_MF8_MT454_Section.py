...
# local imports
from ENDFtk.MF8.MT454 import Section
...
class Test_ENDFtk_MF8_MT457_Section( unittest.TestCase ) :
    ...
    chunk = ( ' 9.223500+4 2.330250+2          2          0          0          09228 8454     \n'
    ...
    def test_section( self ) :
        ...
        chunk = tape.materials.front().file( 8 ).section( 454 ).parse()
