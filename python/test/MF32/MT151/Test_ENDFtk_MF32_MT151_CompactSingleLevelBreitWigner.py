...
# local imports
from ENDFtk.MF32.MT151 import CompactSingleLevelBreitWigner
from ENDFtk.MF32.MT151 import CompactBreitWignerUncertainties
from ENDFtk.MF32.MT151 import CompactCorrelationMatrix

class Test_ENDFtk_MF32_MT151_CompactSingleLevelBreitWigner( unittest.TestCase ) :
    """Unit test for the CompactSingleLevelBreitWigner class."""
    ...
    def test_component( self ) :
        ...
        chunk = CompactSingleLevelBreitWigner(
        ...
        chunk = CompactSingleLevelBreitWigner.from_string( self.chunk, 8228, 32, 151 )

        verify_chunk( self, chunk )

        # the data is copied
        copy = CompactSingleLevelBreitWigner( chunk )
