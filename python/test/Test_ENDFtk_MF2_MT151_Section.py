...
class Test_ENDFtk_MF2_MT151_RMatrixLimited( unittest.TestCase ) :
    ...
    def test_component( self ) :
        ...
        def verify_chunk( self, chunk ) :
            ...
            self.assertEqual( 0, channels1.background_rmatrix_option )
            ...
            self.assertEqual( 0, channels2.background_rmatrix_option )
        ...
        pairs = ParticlePairs( [ 0., 1. ], [ 5.446635e+1, 5.347624e+1 ],
                               ...
                               [ 0, 0 ], [ 102, 2 ] )
        groups = [ SpinGroup(
                     ResonanceChannels( 0.5, 0., [ 0, 0 ], [ 0., 0.5 ], [ 0., 0. ],
                                        [ 0., 0.54373 ], [ 0., 0.54373 ] ),
                     ResonanceParameters( [ -1.223300e+6, 7.788000e+3 ],
                                          [ [ 1., 9.611086e+5 ],
                                            [ 1.455, 1.187354e+3 ] ] ) ),
                   SpinGroup(
                     ResonanceChannels( -0.5, 0., [ 0, 1 ], [ 0., 0.5 ], [ 0., 0. ],
                                        [ 0., 0.54373 ], [ 0., 0.54373 ] ),
        ...
        chunk = tape.material( 2625 ).file( 2 ).section( 151 ).parse()
