...
# local imports
from ENDFtk.MF40 import RectangularMatrix

class Test_ENDFtk_MF40_RectangularMatrix( unittest.TestCase ) :
    """Unit test for the RectangularMatrix class."""

    chunk = (
        " 0.000000+0 0.000000+0          0          6         13          3922840  5     \n"
        " 1.100000+0 1.200000+0 1.300000+0 2.100000+0 2.200000+0 2.300000+0922840  5     \n"
        " 2.400000+0 1.000000+0 2.000000+0 3.000000+0 4.000000+0 5.000000+0922840  5     \n"
        " 6.000000+0                                                       922840  5     \n" )
    ...
    def test_component( self ) :
        ...
        chunk = RectangularMatrix.from_string( self.chunk, 9228, 40, 5 )
