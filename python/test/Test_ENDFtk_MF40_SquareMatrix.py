...
class Test_ENDFtk_MF40_SquareMatrix( unittest.TestCase ) :
    """Unit test for the SquareMatrix class."""

    chunk = (
        " 0.000000+0 0.000000+0          0          5          7          3922840  5     \n"
        " 0.000000+0 1.000000+2 2.000000+2 1.000000+0 2.000000+0 3.000000+0922840  5     \n"
        " 4.000000+0                                                       922840  5     \n" )
    ...
    def test_component( self ) :
        ...
        chunk = SquareMatrix.from_string( self.chunk, 9228, 40, 5 )
