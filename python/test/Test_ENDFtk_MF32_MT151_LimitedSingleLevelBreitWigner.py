...
class Test_ENDFtk_MF2_MT151_LimitedSingleLevelBreitWigner( unittest.TestCase ) :
    """Unit test for the LimitedSingleLevelBreitWigner class."""
    ...
    def test_component( self ) :
        ...
        chunk = LimitedSingleLevelBreitWigner( spin = 1.5, ap = 0.541, lvalues = lvalues )

        verify_chunk( self, chunk )

        # the data is read from a string
        chunk = LimitedSingleLevelBreitWigner.from_string( self.chunk, 1125, 32, 151 )

        verify_chunk( self, chunk )

        # the data is copied
        copy = LimitedSingleLevelBreitWigner( chunk )
    ...
    def test_failures( self ) :
        ...
        with self.assertRaises( Exception ) :
            ...
            chunk = LimitedSingleLevelBreitWigner.from_string( self.invalid_size, 1125, 32, 151 )
