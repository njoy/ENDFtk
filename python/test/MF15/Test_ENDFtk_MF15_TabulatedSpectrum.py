...
class Test_ENDFtk_MF15_TabulatedSpectrum( unittest.TestCase ) :
    """Unit test for the TabulatedSpectrum class."""

    chunk = ( ' 0.000000+0 0.000000+0          0          0          1          2943715 18     \n'
              '          2          4                                            943715 18     \n'
    ...
    def test_component( self ) :
        ...
        chunk = TabulatedSpectrum.from_string( self.chunk, 9437, 15, 18 )
    ...
    def test_failures( self ) :
        ...
        with self.assertRaises( Exception ) :
            ...
            chunk = TabulatedSpectrum.from_string( self.invalid, 9437, 15, 18 )
