...
class Test_ENDFtk_MF15_OutgoingEnergyDistribution( unittest.TestCase ) :
    """Unit test for the OutgoingEnergyDistribution class."""

    chunk = ( ' 0.000000+0 1.000000-5          0          0          1          3943715 18     \n'
              '          3          2                                            943715 18     \n'
    ...
    def test_component( self ) :
        ...
        chunk = OutgoingEnergyDistribution.from_string( self.chunk, 9437, 15, 18 )
    ...
    def test_failures( self ) :
        ...
        with self.assertRaises( Exception ) :
            ...
            chunk = OutgoingEnergyDistribution.from_string( self.invalid, 9437, 15, 18 )
