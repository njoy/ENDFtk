...
# local imports
from ENDFtk.MF32.MT151 import GeneralMultiLevelBreitWigner
from ENDFtk.MF32.MT151 import ShortRangeBreitWignerBlock

class Test_ENDFtk_MF32_MT151_GeneralMultiLevelBreitWigner( unittest.TestCase ) :
    """Unit test for the GeneralMultiLevelBreitWigner class."""
    ...
    def test_component( self ) :
        ...
        chunk = GeneralMultiLevelBreitWigner(
                    awri = 19.82069,
                    spin = 1.5,
                    ap = .33651,
                    dap = .0033651,
        ...
        chunk = GeneralMultiLevelBreitWigner.from_string( self.chunk, 1025, 32, 151 )

        verify_chunk( self, chunk )

        # the data is copied
        copy = GeneralMultiLevelBreitWigner( chunk )
