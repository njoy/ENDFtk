...
from ENDFtk.MF31 import SquareMatrix
from ENDFtk.tree import Tape

class Test_ENDFtk_MF31_Section( unittest.TestCase ) :
    """Unit test for the Section class."""

    chunk = ( " 9.423900+4 2.369986+2          0          0          0          1943731  2     \n"
    ...
    def test_section( self ) :
        ...
        chunk = tape.material( 9437 ).file( 31 ).section( 2 ).parse()
