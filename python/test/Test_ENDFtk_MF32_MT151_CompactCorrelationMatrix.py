...
class Test_ENDFtk_MF32_MT151_CompactCorrelationMatrix( unittest.TestCase ) :
    ...
    def test_component( self ) :
        ...
        def verify_chunk( self, chunk ) :
            ...
            self.assertEqual( 22, len( chunk.I ) )
            self.assertEqual( 22, len( chunk.J ) )
            self.assertEqual( 22, len( chunk.correlations ) )
            ...
            self.assertEqual( 10, chunk.I[19] )
            ...
            self.assertEqual( 23, chunk.J[18] )
            self.assertEqual(  4, chunk.J[19] )
            self.assertEqual(  6, chunk.J[20] )
            self.assertEqual(  8, chunk.J[21] )
            ...
            self.assertAlmostEqual( 0.025, chunk.correlations[18] )
            self.assertAlmostEqual( 0.015, chunk.correlations[19] )
