...
class Test_ENDFtk_MF6_LAW2_TabulatedDistribution( unittest.TestCase ) :
    ...
    chunk_lang14 = ( ' 0.000000+0 1.000000-5         14          0          6          39228 6  5     \n'
                     ' 1.000000+0 2.000000+0 3.000000+0 4.000000+0 5.000000+0 6.000000+09228 6  5     \n' )

    invalid = ( ' 0.000000+0 1.000000-5          1          0          6          39228 6  5     \n'
                ' 1.000000+0 2.000000+0 3.000000+0 4.000000+0 5.000000+0 6.000000+09228 6  5     \n' )

    invalid_size = ( ' 0.000000+0 1.000000-5         12          0          6          49228 6  5     \n'
                     ' 1.000000+0 2.000000+0 3.000000+0 4.000000+0 5.000000+0 6.000000+09228 6  5     \n' )
    ...
    def test_component( self ) :
        ...
        def verify_chunk_lang12( self, chunk ) :
            ...
            # verify string
            self.assertEqual( self.chunk_lang12, chunk.to_string( 9228, 6, 5 ) )
        ...
        chunk = TabulatedDistribution.from_string( self.chunk_lang12, 9228, 6, 5 )
        ...
        # the data is read from a string
        chunk = TabulatedDistribution.from_string( self.chunk_lang14, 9228, 6, 5 )
    ...
    def test_failures( self ) :
        ...
        with self.assertRaises( Exception ) :
            ...
            chunk = TabulatedDistribution.from_string( self.invalid, 9228, 6, 5 )

        with self.assertRaises( Exception ) :

            chunk = TabulatedDistribution.from_string( self.invalid_size, 9228, 6, 5 )
