...
# local imports
from ENDFtk.MF40 import CovariancePairs

class Test_ENDFtk_MF40_CovariancePairs( unittest.TestCase ) :
    """Unit test for the CovariancePairs class."""

    chunk1 = (
        " 0.000000+0 0.000000+0          0          1          4          2922840  5     \n"
        " 1.000000+0 2.000000+0 3.000000+0 4.000000+0                      922840  5     \n" )

    chunk3 = (
        " 0.000000+0 0.000000+0          2          3         10          5922840  5     \n"
        " 1.000000+0 2.000000+0 3.000000+0 4.000000+0 5.000000+0 6.000000+0922840  5     \n"
        " 7.000000+0 8.000000+0 9.000000+0 1.000000+1                      922840  5     \n" )
    ...
    def test_lb1( self ) :
        ...
        chunk = CovariancePairs.from_string( self.chunk1, 9228, 40, 5 )
    ...
    def test_lb3( self ) :
        ...
        # the data is read from a string
        chunk = CovariancePairs.from_string( self.chunk3, 9228, 40, 5 )
