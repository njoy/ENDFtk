...
class Test_ENDFtk_MF1_MT460_Section( unittest.TestCase ) :
    ...
    def test_section( self ) :
        ...
        def verify_chunk_lo1( self, chunk ) :
            ...
            self.assertEqual( 1, photons.photons[0].number_interpolation_regions )
            self.assertEqual( 2, photons.photons[0].NP )
            self.assertEqual( 2, photons.photons[0].number_points )
            self.assertEqual( 1, len( photons.photons[0].INT ) )
            self.assertEqual( 1, len( photons.photons[0].NBT ) )
            self.assertEqual( 4, photons.photons[0].INT[0] )
            self.assertEqual( 2, photons.photons[0].NBT[0] )
            ...
            self.assertEqual( 1, photons.photons[1].number_interpolation_regions )
            self.assertEqual( 3, photons.photons[1].NP )
            self.assertEqual( 3, photons.photons[1].number_points )
            self.assertEqual( 1, len( photons.photons[1].INT ) )
            self.assertEqual( 1, len( photons.photons[1].NBT ) )
            self.assertEqual( 2, photons.photons[1].INT[0] )
            self.assertEqual( 3, photons.photons[1].NBT[0] )
        ...
        chunk = tape.materials.front().file( 1 ).section( 460 ).parse()
