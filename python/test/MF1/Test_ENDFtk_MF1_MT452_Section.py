...
class Test_ENDFtk_MF1_MT452_Section( unittest.TestCase ) :
    ...
    invalid = ( ' 9.223500+4 2.330248+2          0          3          0          09228 1452     \n'
                ' 0.000000+0 0.000000+0          0          0          2          09228 1452     \n'
                ' 2.436700+0 5.000000-2                                            9228 1452     \n' )
    ...
    def test_section( self ) :
        ...
        chunk = tape.materials.front().file( 1 ).section( 452 ).parse()
