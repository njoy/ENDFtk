...
class Test_ENDFtk_MF5_PartialDistribution( unittest.TestCase ) :
    ...
    def test_component( self ) :
        ...
        def verify_chunk_lf9( self, chunk ) :
            ...
            self.assertEqual( 4, d.number_points )
            self.assertEqual( 1, d.NR )
            self.assertEqual( 1, d.number_interpolation_regions )
            self.assertEqual( 1, len( d.INT ) )
            self.assertEqual( 1, len( d.NBT ) )
            self.assertEqual( 2, d.INT[0] )
            self.assertEqual( 4, d.NBT[0] )
            self.assertEqual( 1, len( d.interpolants ) )
            self.assertEqual( 1, len( d.boundaries ) )
            self.assertEqual( 2, d.interpolants[0] )
        ...
        def verify_chunk_lf11( self, chunk ) :
            ...
            self.assertEqual( 3, d.a.number_points )
            self.assertEqual( 1, d.a.NR )
            self.assertEqual( 1, d.a.number_interpolation_regions )
            self.assertEqual( 1, len( d.a.INT ) )
            self.assertEqual( 1, len( d.a.NBT ) )
            self.assertEqual( 2, d.a.INT[0] )
            self.assertEqual( 3, d.a.NBT[0] )
            ...
            self.assertEqual( 5, d.b.number_points )
            self.assertEqual( 1, d.b.NR )
            self.assertEqual( 1, d.b.number_interpolation_regions )
            self.assertEqual( 1, len( d.b.INT ) )
            self.assertEqual( 1, len( d.b.NBT ) )
            self.assertEqual( 2, d.b.INT[0] )
            self.assertEqual( 5, d.b.NBT[0] )
