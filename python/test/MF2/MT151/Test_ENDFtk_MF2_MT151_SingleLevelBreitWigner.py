...
class Test_ENDFtk_MF2_MT151_SingleLevelBreitWigner( unittest.TestCase ) :
    """Unit test for the SingleLevelBreitWigner class."""
    ...
    def test_component( self ) :
        ...
        chunk = SingleLevelBreitWigner( spin = 1.0, ap = 0.893, lvalues = lvalues )

        verify_chunk( self, chunk )

        # the data is read from a string
        chunk = SingleLevelBreitWigner.from_string( self.chunk, 1025, 2, 151 )

        verify_chunk( self, chunk )

        # the data is copied
        copy = SingleLevelBreitWigner( chunk )
    ...
    def test_failures( self ) :
        ...
        with self.assertRaises( Exception ) :
            ...
            chunk = SingleLevelBreitWigner.from_string( self.invalid_size, 1025, 2, 151 )
