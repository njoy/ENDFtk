...
class Test_ENDFtk_MF2_MT151_SpinGroup( unittest.TestCase ) :
    ...
    chunk_background = ( ' 5.000000-1 0.000000+0          1          0         12          22625 2151     \n'
                         ' 1.000000+0 0.000000+0 0.000000+0 0.000000+0 0.000000+0 0.000000+02625 2151     \n'
                         ' 2.000000+0 0.000000+0 5.000000-1 0.000000+0 5.437300-1 5.437300-12625 2151     \n'
                         ' 0.000000+0 0.000000+0          0          2         12          22625 2151     \n'
                         '-1.223300+6 1.000000+0 9.611086+5 0.000000+0 0.000000+0 0.000000+02625 2151     \n'
    ...
    def test_component( self ) :
        ...
        def verify_chunk( self, chunk ) :
            ...
            self.assertEqual( 2, background.NCH )
            self.assertEqual( 2, background.number_channels )
            self.assertEqual( 0, background.KBK )
            self.assertEqual( 0, background.number_background_channels )

            self.assertEqual( 2, len( background.background_rmatrices ) )
            self.assertEqual( True, None == background.background_rmatrices[0] )
            self.assertEqual( True, None == background.background_rmatrices[1] )
        ...
        def verify_chunk_background( self, chunk ) :
            ...
            self.assertAlmostEqual( 0., channels.PJ )
            self.assertAlmostEqual( 0., channels.parity )
            self.assertEqual( 1, channels.KBK )
            self.assertEqual( 1, channels.number_background_channels )
            self.assertEqual( 0, channels.KPS )
            self.assertEqual( 0, channels.phase_shift_option )
            self.assertEqual( 2, channels.NCH )
            self.assertEqual( 2, channels.number_channels )
            ...
            self.assertEqual( 2, background.NCH )
            self.assertEqual( 2, background.number_channels )
            self.assertEqual( 1, background.KBK )
            self.assertEqual( 1, background.number_background_channels )

            self.assertEqual( 2, len( background.background_rmatrices ) )
            self.assertEqual( True, None == background.background_rmatrices[0] )
            self.assertEqual( False,  None ==background.background_rmatrices[1] )

            self.assertEqual( 2, background.background_rmatrices[1].LBK )
            self.assertEqual( 2, background.background_rmatrices[1].representation )
            self.assertEqual( 2, background.background_rmatrices[1].LCH )
            self.assertEqual( 2, background.background_rmatrices[1].channel_index )

            self.assertAlmostEqual( 1., background.background_rmatrices[1].ED )
            self.assertAlmostEqual( 2., background.background_rmatrices[1].EU )
            self.assertAlmostEqual( 3., background.background_rmatrices[1].R0 )
            self.assertAlmostEqual( 4., background.background_rmatrices[1].R1 )
            self.assertAlmostEqual( 5., background.background_rmatrices[1].R2 )
            self.assertAlmostEqual( 6., background.background_rmatrices[1].S0 )
            self.assertAlmostEqual( 7., background.background_rmatrices[1].S1 )

            self.assertEqual( 9, chunk.NC )

            # verify string
            self.assertEqual( self.chunk_background, chunk.to_string( 2625, 2, 151 ) )
        ...
        verify_chunk_background( self, chunk )

        # the data is read from a string
        chunk = SpinGroup.from_string( self.chunk_background, 2625, 2, 151 )
        ...
        verify_chunk_background( self, copy )
