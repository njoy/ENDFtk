...
void wrapUnresolvedEnergyIndependent( python::module& module ) {

  // type aliases
  using Component = njoy::ENDFtk::section::Type< 2, 151 >::UnresolvedEnergyIndependent;
  using LValue = njoy::ENDFtk::section::Type< 2, 151 >::UnresolvedEnergyIndependent::LValue;
  ...
  .def(
    ...
    python::arg( "lvalues" ),
    "Initialise the unresolved energy independent parameters\n\n"
    "Arguments:\n"
    "    self       the unresolved energy independent parameters\n"
  ...
  .def(
    ...
    "Initialise the unresolved energy independent resonances with other\n"
    "resonances\n\n"
    "Arguments:\n"
    "    self          the unresolved energy independent resonances object\n"
