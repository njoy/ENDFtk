...
void wrapTabulatedSpectrum( python::module& module ) {

  // type aliases
  using Component = njoy::ENDFtk::section::Type< 5 >::TabulatedSpectrum;
  using Distribution = njoy::ENDFtk::section::Type< 5 >::TabulatedSpectrum::OutgoingEnergyDistribution;
